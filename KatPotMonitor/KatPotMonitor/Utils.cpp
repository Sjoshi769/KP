...
//Utils.Cpp. This file contains utility programs.
...
//using namespace Microsoft::VisualBasic::Compatibility;

#if 0
DialogResult ShowDialog(String^ input)
{
    return InputBox.ShowDialog(null, null, null, out input, InputBoxResultType.Any);
}

DialogResult ShowDialog(string caption, string prompt, string defaultValue,
